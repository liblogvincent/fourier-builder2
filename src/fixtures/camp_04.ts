...
export const plan: CampaignPlan = {
  ...
  rationale: {
    ...
    why: [
      ...
      "DACH markets require EU compliance review — H-C gate ensures creative alignment before localization",
    ],
    alternatives: [
      {
  ...
  nodes: [
    ...
    { id: "n_h1", label: "H1: Brief Approval", kind: "gate", gate: "H1", status: "pending", depends_on: ["n_plan"] },
    { id: "n_h2", label: "H2: Plan Review", kind: "gate", gate: "H2", status: "pending", depends_on: ["n_h1"] },
    { id: "n_content", label: "Content generation", kind: "agent", agent: "content", status: "pending", depends_on: ["n_h2"] },
    { id: "n_hc", label: "H-C: Creative Approval", kind: "gate", gate: "H-C", status: "pending", depends_on: ["n_content"] },
    { id: "n_locale", label: "Localization", kind: "agent", agent: "localization", status: "pending", depends_on: ["n_hc"] },
    { id: "n_rollout", label: "Roll-out", kind: "agent", agent: "rollout", status: "pending", depends_on: ["n_locale"] },
    { id: "n_qa", label: "QA + brand judge", kind: "agent", agent: "qa", status: "pending", depends_on: ["n_rollout"] },
    { id: "n_h3", label: "H3: QA Disposition", kind: "gate", gate: "H3", status: "pending", depends_on: ["n_qa"] },
